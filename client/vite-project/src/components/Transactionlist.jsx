  ...
  return (
    <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
      ...
      <div className="flex gap-3 mb-6">
        ...
        <select className="border-2 bg-gray-50 border-gray-200 rounded-xl py-3 px-4 text-sm font-semibold text-gray-700 focus:outline-none cursor-pointer focus:border-indigo-500" value={filterCategory}>
